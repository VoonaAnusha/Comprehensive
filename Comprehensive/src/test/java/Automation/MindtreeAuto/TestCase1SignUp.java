...
public class TestCase1SignUp {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.cssSelector("#spree_user_email")).sendKeys("anushavoona193@gmai.com");
		driver.findElement(By.xpath("(//input[@id='spree_user_password'])[2]")).click();
		driver.findElement(By.xpath("(//input[@id='spree_user_password'])[2]")).sendKeys("Anusha@123");
