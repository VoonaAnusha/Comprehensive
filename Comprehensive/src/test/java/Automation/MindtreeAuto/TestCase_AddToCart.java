...
public class TestCase_AddToCart {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\mindsdet292\\Desktop\\chromedriver.exe");
		...
		driver.findElement(By.xpath("(//input[@id='spree_user_email'])[2]")).sendKeys("anushavoona193@gmail.com");
		driver.findElement(By.xpath("(//input[@id='spree_user_password'])[3]")).click();
		driver.findElement(By.xpath("(//input[@id='spree_user_password'])[3]")).sendKeys("Anusha@123");
		...
		driver.findElement(By.xpath("(//textarea[@placeholder='Address'])[1]")).sendKeys("hyderabad");
		...
		driver.findElement(By.id("order_ship_address_attributes_phone")).sendKeys("9100286891");
